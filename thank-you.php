<?php
/**
 * Interventional Psychiatry of Arizona — form confirmation page.
...
<style>
  ...
  /* Same frosted panel as the consult form, so the confirmation feels like the
     other side of the same card. */
  .glass{
...
<main class="relative min-h-screen flex flex-col items-center justify-center px-6 py-14">
  ...
  <a href="/" class="rise inline-block" aria-label="Interventional Psychiatry of Arizona — home">
  ...
  <div class="glass rise mt-9 w-full max-w-xl rounded-[28px] p-8 sm:p-10 text-center" style="animation-delay:.08s">
    ...
    <p class="mt-5 text-[16.5px] leading-relaxed text-cream/70 font-light">
      A member of our team will reach out within one business day to set up your
      consultation and answer anything you are wondering about.
    </p>

    <div class="mt-8 grid sm:grid-cols-2 gap-3 text-left">
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
        <p class="text-[11.5px] uppercase tracking-[0.16em] text-cream/40">What happens next</p>
        <p class="mt-1.5 text-[14.5px] leading-snug text-cream/80">We call or email you to find a time that works.</p>
      </div>
      <div class="rounded-2xl border border-white/12 bg-white/[0.04] px-5 py-4">
        <p class="text-[11.5px] uppercase tracking-[0.16em] text-cream/40">Sooner is fine</p>
        <p class="mt-1.5 text-[14.5px] leading-snug text-cream/80">Call us directly Monday to Friday, 8am–5pm.</p>
      </div>
    </div>
    ...
    <div class="mt-8 flex flex-col sm:flex-row gap-3.5">
      ...
      <a href="/" class="group flex-1 inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-7 py-4 text-[15.5px] font-medium text-cream hover:bg-white/10 transition backdrop-blur">
